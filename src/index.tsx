...
export const LoaderComponent = ({ loading, backgroundColor = 'rgba(236, 240, 241, 0.7)', loadingColor = '#e74c3c' }: LoaderProps) => {
  ...
  return (
    ...
    loading ? <div className='loading_background' style={backgroundColorStyle}>
